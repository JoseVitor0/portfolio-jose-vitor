...
export default function App() {
  return (
    <>
      {/* 1. Elemento de fundo (Mesh Gradient) fixo */}
      ...
      {/* 2. Restante do conteúdo do seu portfólio */}
      ...
      {/* Seção inicial com foto à esquerda */}
      <section className="flex flex-col md:flex-row items-center md:items-start justify-center md:justify-start text-center md:text-left py-24 px-6 gap-10 max-w-6xl mx-auto">
        ...
        <div className="flex-1 flex justify-center md:justify-start">
          <img
            src="/profpicture.jpg" // Coloque sua imagem na pasta public
        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <div className="flex-1">
            ...
            <div className="text-gray-300 leading-relaxed space-y-4">
              ...
              <p>
                Minha paixão por tecnologia começou cedo, resolvendo bugs no Windows e aprendendo sobre hardwares por conta própria.
                Durante a graduação, aprofundei meus conhecimentos em áreas fundamentais como compiladores, algoritmos, desenvolvimento de softwares e aplicativos e IA.
              </p>
              <p>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {["Java", "Python", "JavaScript", "React", "Node.js", "SQL", "Kotlin", "C", "Flask"].map(skill => (
              ...
              {/* Ciência da Computação (Seu diferencial) */}
              <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {certificados.map((cert, index) => (
            <div key={index} className="bg-[#1a1a1a] rounded-2xl overflow-hidden border border-gray-800 hover:border-purple-500 transition-all group shadow-2xl">
              ...
              {/* 2. Aumentamos a altura de h-40 para h-64 (ou h-72) para a imagem ficar bem grande */}
              ...
              {/* 3. Aumentamos o padding (p-4 para p-6) e o tamanho da fonte */}
              <div className="p-6">
      ...
      <section id="projetos" className="px-6 py-20 bg-[#141414]">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
            <div>
              <h3 className="text-3xl font-bold text-purple-400 mb-2">Projetos em Destaque</h3>
              <p className="text-gray-400">Uma seleção dos meus principais trabalhos acadêmicos e técnicos.</p>
            </div>
            <a
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {meusProjetos.map((proj, i) => (
              <div key={i} className="bg-[#1e1e1e] rounded-2xl p-8 border border-gray-800 hover:border-purple-500/50 transition-all group flex flex-col shadow-lg">
